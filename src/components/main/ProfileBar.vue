<template>
          ...
          >
            <div class="sidebar-content">
              ...
              <div class="sidebar-footer">
                <button class="withdraw-button" @click="showWithdrawModal">탈퇴하기</button>
              </div>
            </div>
          </div>
        </Transition>
        ...
        <Transition name="modal-content">
          <div v-if="isLogoutModalVisible" class="modal-content" @click.stop>
            ...
            <div class="modal-footer">
              ...
              <button class="modal-cancel-btn" @click="closeLogoutModal">취소</button>              
            </div>
          </div>
        </Transition>
      </div>
    ...
    <!-- 탈퇴 확인 모달 -->
    <Transition name="modal-overlay">
      <div v-if="isWithdrawModalVisible" class="modal-overlay" @click="closeWithdrawModal">
        <Transition name="modal-content">
          <div v-if="isWithdrawModalVisible" class="modal-content" @click.stop>
            ...
            <div class="modal-footer">
              <button class="modal-withdraw-btn" @click="confirmWithdraw">탈퇴</button>
              <button class="modal-cancel-btn" @click="closeWithdrawModal">취소</button>
            </div>
          </div>
        </Transition>
      </div>
